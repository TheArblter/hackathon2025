...
class Pet():
    ...
    def update(self):
        ...
        #use int to round down from to integers since only have 3 animations (animation_action is set to 0 and animation_speed is set to .05 so it naturally goes up in increments of .05 and dont we dont have .05 of image) 
